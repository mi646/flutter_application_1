...
class KitchenDetailPage extends StatelessWidget {
  ...
  KitchenDetailPage({required this.product, required this.addToCart});
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Description
                      const Text(
                        "Explore our collection of kitchen items that combine style, durability, and functionality. Perfect for any kitchen setup.",
                        style: TextStyle(
                          fontSize: 16,
