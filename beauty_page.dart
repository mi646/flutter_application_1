...
import 'package:flutter_application_1/screens/beauty_detail_page.dart';
...
class BeautyPage extends StatelessWidget {
  ...
  BeautyPage({required this.products, required this.addToCart});
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            ...
            crossAxisSpacing: 12,
            mainAxisSpacing: 12,
            childAspectRatio: 0.75,  // Similar aspect ratio as CandyPage
          ),
    ...
    return Consumer<WishlistProvider>(
      builder: (context, wishlistProvider, child) {
        ...
        return GestureDetector(
          onTap: () {
            // Navigating to BeautyDetailPage when a card is tapped
            Navigator.push(
              context,
              MaterialPageRoute(
