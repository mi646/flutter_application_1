...
import 'package:flutter_application_1/screens/hardware_detail_page.dart';
...
class HardwarePage extends StatelessWidget {
  ...
  HardwarePage({required this.products, required this.addToCart});
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            ...
            crossAxisSpacing: 12,
            mainAxisSpacing: 12,
            childAspectRatio: 0.75,  // Similar aspect ratio as DecorationPage
          ),
    ...
    return Consumer<WishlistProvider>(
      builder: (context, wishlistProvider, child) {
        ...
        return GestureDetector(
          onTap: () {
            // Navigating to HardwareDetailPage when a card is tapped
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HardwareDetailPage(
                  product: product,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        height: 40,  // Increased height for better button visibility
