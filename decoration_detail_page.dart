...
class DecorationDetailPage extends StatelessWidget {
  ...
  DecorationDetailPage({required this.product, required this.addToCart});
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Description
                      const Text(
                        "Add elegance and charm to your space with our exquisite collection of decorations. Carefully crafted to enhance the beauty of any room.",
                        style: TextStyle(
                          fontSize: 16,
