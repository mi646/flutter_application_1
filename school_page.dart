...
import 'package:flutter_application_1/screens/school_detail_page.dart';
...
class SchoolPage extends StatelessWidget {
  ...
  SchoolPage({required this.products, required this.addToCart});
        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [Colors.blueAccent, Colors.lightBlueAccent], // School colors 🌟
    ...
    return Consumer<WishlistProvider>(
      builder: (context, wishlistProvider, child) {
        ...
        return GestureDetector(
          onTap: () {
            // Navigate to SchoolDetailPage when a card is tapped
            Navigator.push(
              context,
              MaterialPageRoute(
